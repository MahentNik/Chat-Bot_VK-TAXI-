...
class Receipt(SqlAlchemyBase):
    ...
    first_place_latitude = sqlalchemy.Column(sqlalchemy.Float, nullable=False, unique=False)
    first_place_longitude = sqlalchemy.Column(sqlalchemy.Float, nullable=False, unique=False)
    second_place_latitude = sqlalchemy.Column(sqlalchemy.Float, nullable=False, unique=False)
    second_place_longitude = sqlalchemy.Column(sqlalchemy.Float, nullable=False, unique=False)
